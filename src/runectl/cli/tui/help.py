...
writes down everything it tries. This screen watches that happen, live or replayed.

[b]The run list[/b] (left)
Every run you've started or browsed before. Press [b]n[/b] to start a new one — it
composes and shows you the exact command before launching, nothing hidden.
